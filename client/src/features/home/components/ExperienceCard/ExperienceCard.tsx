...
export function ExperienceCard({
  ...
  return (
    <article className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-zinc-300 hover:shadow-md">
      <p className="text-sm font-medium text-zinc-500">{companyName}</p>
